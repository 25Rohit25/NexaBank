...
Live Ollama/MCP/pgvector smoke testing, Redis-backed conversation memory, AI safety evaluations, frontend, service container images, observability, and Kubernetes remain deferred.
